...
DOTFILES = gitconfig vimrc Xresources Xmodmap zshrc zshrc.local fehbg offlineimaprc offlineimap.py msmtprc conkyrc-date.lua conkyrc-infos.lua synergy.conf
